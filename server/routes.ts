  ...
  app.get("/api/menu", async (_req: Request, res: Response) => {
    try {
      ...
      const response = items.map(p => ({
        ...
        unit: p.unit || "pcs",
        quantityStep: typeof p.quantityStep === 'number' ? p.quantityStep : 1,
        brand: p.brand,
    ...
    try {
      ...
      res.status(201).json({ 
        ...
        product: {
          ...
          quantityStep: typeof created.quantityStep === 'number' ? created.quantityStep : 1,
          brand: created.brand,
    ...
    try {
      ...
      res.json({ 
        product: { 
          ...
          quantityStep: typeof updated.quantityStep === 'number' ? updated.quantityStep : 1,
          brand: updated.brand,
