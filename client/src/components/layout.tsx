            ...
            <div className="mt-6">
              ...
              <div className="flex items-center gap-6 text-sm">
                ...
                {!!socialLinks?.x && (
                  ...
                  >
                    <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.514l-5.106-6.694-5.834 6.694H2.423l7.732-8.835L1.899 2.25h6.687l4.622 6.112 5.296-6.112zM16.884 19.75h1.747L6.362 3.75H4.432l12.452 16z" />
                    </svg>
                  </a>
                )}
              </div>
